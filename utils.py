...
def setup_folders(running_folder, done_folder, ring_pipeline_folder, data_template_file, my_email) -> None:
    ...
    permission = SyftPermission.mine_with_public_write(my_email)
    permission.ensure(ring_pipeline_folder)